...
public class CreateTopicUseCaseShould
{
    ...
    [Fact]
    public async Task ThrowIntentionManagerExceptionWhenTopicCreationIsNotAllowed()
    {
    ...
    [Fact]
    public async Task ThrowForumNotFoundExceptionWhenNoMatchingForum()
    {
    ...
    public async Task ReturnNewlyCreatedTopicWhenMatchingForumExists()
    {
        ...
        intentionIsAllowedSetup.Returns(true);
        getForumsSetup.ReturnsAsync([new() { Id = forumId, Title = "A Forum"}]);
