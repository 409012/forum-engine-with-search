...
using Xunit;
using Comment = FEwS.Forums.Domain.Models.Comment;
...
public class CreateCommentStorageShould(StorageTestFixture fixture) : IClassFixture<StorageTestFixture>
{
    private readonly CreateCommentStorage sut = new(
        fixture.GetDbContext(), fixture.GetMapper(), new GuidFactory(), new FakeTimeProvider());

    [Fact]
    public async Task ReturnNullForTopicWhenNoMatchingTopicInDb()
    {
    ...
    [Fact]
    public async Task ReturnFoundTopicWhenTopicIsPresentInDb()
    {
